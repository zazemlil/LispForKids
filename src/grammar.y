...
%token T_QUOTE T_CAR T_CDR T_CONS T_ATOM T_EQUAL T_ADD 
%token T_SUB T_MUL T_DIV T_REM T_LEQ T_COND T_LAMBDA T_LET T_LETREC 

%token T_END_OF_FILE

%%

program: expr T_IDENTIFIER T_LITERAL_INT T_END_OF_FILE {
    //($1)->print(0);
